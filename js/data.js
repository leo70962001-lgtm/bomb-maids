...
(function (G) {
  ...
  G.LINES = {
    ...
    yoru: {
      ...
      talk: [
        ['……有事？', '……灰塵，都斬乾淨了。', '……這個房間的每個角落，我都記得。'],
        ['……主人的杯子放歪了。我調好了。', '……話多的人，我不擅長應付。', '……看主人忙來忙去，很有趣。'],
        ['……主人今天也在看我。……可以再看久一點。', '……害羞的表情，不錯。', '……別離開我的視線範圍。'],
        ['……主人是我的。這點不用討論。', '……偶爾，我也想被誇獎。'],
        ['……主人，過來。……嗯，這樣就好。', '……要是逃跑，我會去追。'],
      ],
      talkMany: '……今天，說太多了。',
      giftLike: '……抹茶。……算你識相。',
      giftNormal: '……收下了。',
    ...
    honey: {
      ...
      talk: [
        ['今天的鬆餅……咦，我烤了嗎？', '砂糖和鹽長得好像喔，主人覺得呢？', '蜜糖最喜歡烤點心了♪'],
        ['啊、主人的杯子，我洗過了……應該吧？', '小兔子今天也很有精神喔～', '跟主人在一起，就會忘記時間呢。'],
        ['主人愛吃甜的嗎？蜜糖記起來了！', '欸嘿嘿，剛剛在想主人的事，結果糖放了兩次。', '主人笑起來的樣子，蜜糖最喜歡了。'],
        ['主人，今天也留在蜜糖身邊嘛～', '啊……剛剛想說什麼來著？……嗯，喜歡主人！'],
        ['主人是蜜糖的第一名喔♪', '欸嘿嘿……牽手可以嗎？'],
      ],
    ...
    yukino: {
      ...
      talk: [
        ['主人的書桌，姊姊幫你整理好了。', '眼鏡嗎？只是看書用的，度數其實很淺。', '有什麼煩惱，都可以跟姊姊說喔。'],
        ['主人，今天有好好吃飯嗎？', '呵呵，看著主人努力的樣子，姊姊很開心。', '要不要靠著休息一下？肩膀借你。'],
        ['主人偶爾也可以任性一點喔。', '這種粗活，讓姊姊來就好。', '……被主人依賴的感覺，其實不壞呢。'],
        ['主人，今天也讓姊姊多疼你一點吧？', '……真是的，明明是主人，卻讓人想寵著。'],
        ['主人的第一名，姊姊可不會讓給別人喔。', '……呵呵，姊姊也是會吃醋的。'],
      ],
